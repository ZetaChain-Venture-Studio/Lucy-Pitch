...
export const Balance = ({ address, className = "", usdMode }: BalanceProps) => {
  ...
  return (
    <button
      ...
      type="button"
    >
      <div className="w-full flex gap-2 items-center justify-center text-[#1100FF] font-inter font-black mr-2">
        {displayUsdMode ? (
          <>
            <span className="">$</span>
          ...
          <>
            ...
            <span className="">{targetNetwork.nativeCurrency.symbol}</span>
          </>
        )}
      </div>
    </button>
